...
from statistics_gaussian_binomial_distributions import Gaussian
from statistics_gaussian_binomial_distributions import Binomial

class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        self.gaussian = Gaussian(25, 2)
        self.gaussian.read_data_file('statistics_python_package/number.txt')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial.read_data_file('statistics_python_package/numbers_binomial.txt')
